/* @ts-self-types="./mimi_wasm.d.ts" */

export class MimiEngine {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(MimiEngine.prototype);
        obj.__wbg_ptr = ptr;
        MimiEngineFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        MimiEngineFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_mimiengine_free(ptr, 0);
    }
    /**
     ...
     */
    decode(tokens, num_codebooks) {
        const ptr0 = passArray32ToWasm0(tokens, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.mimiengine_decode(this.__wbg_ptr, ptr0, len0, num_codebooks);
    ...
    encode(pcm) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.mimiengine_encode(this.__wbg_ptr, ptr0, len0);
     ...
     * @returns {MimiEngine}
     */
    static load(data, num_codebooks) {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.mimiengine_load(ptr0, len0, num_codebooks);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return MimiEngine.__wrap(ret[0]);
    }
    /**
     ...
     */
    get num_codebooks() {
        const ret = wasm.mimiengine_num_codebooks(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    reset() {
        wasm.mimiengine_reset(this.__wbg_ptr);
    }
    /**
     ...
     */
    get sample_rate() {
        const ret = wasm.mimiengine_sample_rate(this.__wbg_ptr);
        return ret >>> 0;
    }
}
if (Symbol.dispose) MimiEngine.prototype[Symbol.dispose] = MimiEngine.prototype.free;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./mimi_wasm_bg.js": import0,
    };
}

const MimiEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_mimiengine_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('mimi_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
